...
# then we have to find fstring expressions and evaluate/replcae them with eval and str.format and not any extra '}' f'`{25:{4}}}} -> f'`  025}}' so want to get {5*5:{4}} and not {5*5:{4}}}} so thats why were not also replacing '}}' with something else yet
